 ...
 * @method     ChildSocolissimoAreaFreeshipping findOneByCartAmount(double $cart_amount) Return the first ChildSocolissimoAreaFreeshipping filtered by the cart_amount column
 *
 ...
 * @method     array findByCartAmount(double $cart_amount) Return ChildSocolissimoAreaFreeshipping objects filtered by the cart_amount column
 *
 */
